...
# 53 "/home/pedro-linux/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8/pic/include/proc/pic16f18875.h"
...
# 24457
extern volatile unsigned char ZCD1CON __at(0x91F);

asm("ZCD1CON equ 091Fh");
...
extern volatile ZCD1CONbits_t ZCD1CONbits __at(0x91F);
...
# 27635
extern volatile unsigned char CLC3CON __at(0xE24);

asm("CLC3CON equ 0E24h");
...
extern volatile CLC3CONbits_t CLC3CONbits __at(0xE24);

# 27753
extern volatile unsigned char CLC3POL __at(0xE25);

asm("CLC3POL equ 0E25h");
...
extern volatile CLC3POLbits_t CLC3POLbits __at(0xE25);

# 27831
extern volatile unsigned char CLC3SEL0 __at(0xE26);

asm("CLC3SEL0 equ 0E26h");
...
extern volatile CLC3SEL0bits_t CLC3SEL0bits __at(0xE26);

# 27959
extern volatile unsigned char CLC3SEL1 __at(0xE27);

asm("CLC3SEL1 equ 0E27h");
...
extern volatile CLC3SEL1bits_t CLC3SEL1bits __at(0xE27);

# 28087
extern volatile unsigned char CLC3SEL2 __at(0xE28);

asm("CLC3SEL2 equ 0E28h");
...
extern volatile CLC3SEL2bits_t CLC3SEL2bits __at(0xE28);

# 28215
extern volatile unsigned char CLC3SEL3 __at(0xE29);

asm("CLC3SEL3 equ 0E29h");
...
extern volatile CLC3SEL3bits_t CLC3SEL3bits __at(0xE29);

# 28343
extern volatile unsigned char CLC3GLS0 __at(0xE2A);

asm("CLC3GLS0 equ 0E2Ah");
...
extern volatile CLC3GLS0bits_t CLC3GLS0bits __at(0xE2A);

# 28455
extern volatile unsigned char CLC3GLS1 __at(0xE2B);

asm("CLC3GLS1 equ 0E2Bh");
...
extern volatile CLC3GLS1bits_t CLC3GLS1bits __at(0xE2B);

# 28567
extern volatile unsigned char CLC3GLS2 __at(0xE2C);

asm("CLC3GLS2 equ 0E2Ch");
...
extern volatile CLC3GLS2bits_t CLC3GLS2bits __at(0xE2C);

# 28679
extern volatile unsigned char CLC3GLS3 __at(0xE2D);

asm("CLC3GLS3 equ 0E2Dh");
...
extern volatile CLC3GLS3bits_t CLC3GLS3bits __at(0xE2D);

# 28791
extern volatile unsigned char CLC4CON __at(0xE2E);

asm("CLC4CON equ 0E2Eh");
...
extern volatile CLC4CONbits_t CLC4CONbits __at(0xE2E);

# 28909
extern volatile unsigned char CLC4POL __at(0xE2F);

asm("CLC4POL equ 0E2Fh");
...
extern volatile CLC4POLbits_t CLC4POLbits __at(0xE2F);

# 28987
extern volatile unsigned char CLC4SEL0 __at(0xE30);

asm("CLC4SEL0 equ 0E30h");
...
extern volatile CLC4SEL0bits_t CLC4SEL0bits __at(0xE30);

# 29115
extern volatile unsigned char CLC4SEL1 __at(0xE31);

asm("CLC4SEL1 equ 0E31h");
...
extern volatile CLC4SEL1bits_t CLC4SEL1bits __at(0xE31);

# 29243
extern volatile unsigned char CLC4SEL2 __at(0xE32);

asm("CLC4SEL2 equ 0E32h");
...
extern volatile CLC4SEL2bits_t CLC4SEL2bits __at(0xE32);

# 29371
extern volatile unsigned char CLC4SEL3 __at(0xE33);

asm("CLC4SEL3 equ 0E33h");
...
extern volatile CLC4SEL3bits_t CLC4SEL3bits __at(0xE33);

# 29499
extern volatile unsigned char CLC4GLS0 __at(0xE34);

asm("CLC4GLS0 equ 0E34h");
...
extern volatile CLC4GLS0bits_t CLC4GLS0bits __at(0xE34);

# 29611
extern volatile unsigned char CLC4GLS1 __at(0xE35);

asm("CLC4GLS1 equ 0E35h");
...
extern volatile CLC4GLS1bits_t CLC4GLS1bits __at(0xE35);

# 29723
extern volatile unsigned char CLC4GLS2 __at(0xE36);

asm("CLC4GLS2 equ 0E36h");
...
extern volatile CLC4GLS2bits_t CLC4GLS2bits __at(0xE36);

# 29835
extern volatile unsigned char CLC4GLS3 __at(0xE37);

asm("CLC4GLS3 equ 0E37h");
...
extern volatile CLC4GLS3bits_t CLC4GLS3bits __at(0xE37);
...
# 30267
extern volatile unsigned char T5CKIPPS __at(0xE96);

asm("T5CKIPPS equ 0E96h");
...
extern volatile T5CKIPPSbits_t T5CKIPPSbits __at(0xE96);

# 30319
extern volatile unsigned char T5GPPS __at(0xE97);

asm("T5GPPS equ 0E97h");
...
extern volatile T5GPPSbits_t T5GPPSbits __at(0xE97);
...
# 30475
extern volatile unsigned char T6AINPPS __at(0xE9E);

asm("T6AINPPS equ 0E9Eh");
...
extern volatile T6AINPPSbits_t T6AINPPSbits __at(0xE9E);
...
# 30631
extern volatile unsigned char CCP3PPS __at(0xEA3);

asm("CCP3PPS equ 0EA3h");
...
extern volatile CCP3PPSbits_t CCP3PPSbits __at(0xEA3);

# 30683
extern volatile unsigned char CCP4PPS __at(0xEA4);

asm("CCP4PPS equ 0EA4h");
...
extern volatile CCP4PPSbits_t CCP4PPSbits __at(0xEA4);

# 30735
extern volatile unsigned char CCP5PPS __at(0xEA5);

asm("CCP5PPS equ 0EA5h");
...
extern volatile CCP5PPSbits_t CCP5PPSbits __at(0xEA5);

# 30793
extern volatile unsigned char SMT1WINPPS __at(0xEA9);

asm("SMT1WINPPS equ 0EA9h");
...
extern volatile SMT1WINPPSbits_t SMT1WINPPSbits __at(0xEA9);

# 30845
extern volatile unsigned char SMT1SIGPPS __at(0xEAA);

asm("SMT1SIGPPS equ 0EAAh");
...
extern volatile SMT1SIGPPSbits_t SMT1SIGPPSbits __at(0xEAA);

# 30897
extern volatile unsigned char SMT2WINPPS __at(0xEAB);

asm("SMT2WINPPS equ 0EABh");
...
extern volatile SMT2WINPPSbits_t SMT2WINPPSbits __at(0xEAB);

# 30949
extern volatile unsigned char SMT2SIGPPS __at(0xEAC);

asm("SMT2SIGPPS equ 0EACh");
...
extern volatile SMT2SIGPPSbits_t SMT2SIGPPSbits __at(0xEAC);
...
# 31053
extern volatile unsigned char CWG2PPS __at(0xEB2);

asm("CWG2PPS equ 0EB2h");
...
extern volatile CWG2PPSbits_t CWG2PPSbits __at(0xEB2);

# 31105
extern volatile unsigned char CWG3PPS __at(0xEB3);

asm("CWG3PPS equ 0EB3h");
...
extern volatile CWG3PPSbits_t CWG3PPSbits __at(0xEB3);

# 31157
extern volatile unsigned char MDCARLPPS __at(0xEB8);

asm("MDCARLPPS equ 0EB8h");
...
extern volatile MDCARLPPSbits_t MDCARLPPSbits __at(0xEB8);

# 31209
extern volatile unsigned char MDCARHPPS __at(0xEB9);

asm("MDCARHPPS equ 0EB9h");
...
extern volatile MDCARHPPSbits_t MDCARHPPSbits __at(0xEB9);

# 31261
extern volatile unsigned char MDSRCPPS __at(0xEBA);

asm("MDSRCPPS equ 0EBAh");
...
extern volatile MDSRCPPSbits_t MDSRCPPSbits __at(0xEBA);
...
# 31729
extern volatile unsigned char SSP2CLKPPS __at(0xEC8);

asm("SSP2CLKPPS equ 0EC8h");
...
extern volatile SSP2CLKPPSbits_t SSP2CLKPPSbits __at(0xEC8);

# 31781
extern volatile unsigned char SSP2DATPPS __at(0xEC9);

asm("SSP2DATPPS equ 0EC9h");
...
extern volatile SSP2DATPPSbits_t SSP2DATPPSbits __at(0xEC9);

# 31833
extern volatile unsigned char SSP2SSPPS __at(0xECA);

asm("SSP2SSPPS equ 0ECAh");
...
extern volatile SSP2SSPPSbits_t SSP2SSPPSbits __at(0xECA);

# 31885
extern volatile unsigned char RXPPS __at(0xECB);
...
extern volatile RXPPSbits_t RXPPSbits __at(0xECB);

# 31937
extern volatile unsigned char TXPPS __at(0xECC);
...
extern volatile TXPPSbits_t TXPPSbits __at(0xECC);
...
# 32189
extern volatile unsigned char RA4PPS __at(0xF14);

asm("RA4PPS equ 0F14h");
...
extern volatile RA4PPSbits_t RA4PPSbits __at(0xF14);

# 32239
extern volatile unsigned char RA5PPS __at(0xF15);

asm("RA5PPS equ 0F15h");
...
extern volatile RA5PPSbits_t RA5PPSbits __at(0xF15);

# 32289
extern volatile unsigned char RA6PPS __at(0xF16);

asm("RA6PPS equ 0F16h");
...
extern volatile RA6PPSbits_t RA6PPSbits __at(0xF16);

# 32339
extern volatile unsigned char RA7PPS __at(0xF17);

asm("RA7PPS equ 0F17h");
...
extern volatile RA7PPSbits_t RA7PPSbits __at(0xF17);
...
# 32789
extern volatile unsigned char RC0PPS __at(0xF20);

asm("RC0PPS equ 0F20h");
...
extern volatile RC0PPSbits_t RC0PPSbits __at(0xF20);

# 32839
extern volatile unsigned char RC1PPS __at(0xF21);

asm("RC1PPS equ 0F21h");
...
extern volatile RC1PPSbits_t RC1PPSbits __at(0xF21);

# 32889
extern volatile unsigned char RC2PPS __at(0xF22);

asm("RC2PPS equ 0F22h");
...
extern volatile RC2PPSbits_t RC2PPSbits __at(0xF22);

# 32939
extern volatile unsigned char RC3PPS __at(0xF23);

asm("RC3PPS equ 0F23h");
...
extern volatile RC3PPSbits_t RC3PPSbits __at(0xF23);
...
# 33139
extern volatile unsigned char RC7PPS __at(0xF27);

asm("RC7PPS equ 0F27h");
...
extern volatile RC7PPSbits_t RC7PPSbits __at(0xF27);

# 33189
extern volatile unsigned char RD0PPS __at(0xF28);

asm("RD0PPS equ 0F28h");
...
extern volatile RD0PPSbits_t RD0PPSbits __at(0xF28);

# 33239
extern volatile unsigned char RD1PPS __at(0xF29);

asm("RD1PPS equ 0F29h");
...
extern volatile RD1PPSbits_t RD1PPSbits __at(0xF29);

# 33289
extern volatile unsigned char RD2PPS __at(0xF2A);

asm("RD2PPS equ 0F2Ah");
...
extern volatile RD2PPSbits_t RD2PPSbits __at(0xF2A);

# 33339
extern volatile unsigned char RD3PPS __at(0xF2B);

asm("RD3PPS equ 0F2Bh");
...
extern volatile RD3PPSbits_t RD3PPSbits __at(0xF2B);

# 33389
extern volatile unsigned char RD4PPS __at(0xF2C);

asm("RD4PPS equ 0F2Ch");
...
extern volatile RD4PPSbits_t RD4PPSbits __at(0xF2C);

# 33439
extern volatile unsigned char RD5PPS __at(0xF2D);

asm("RD5PPS equ 0F2Dh");
...
extern volatile RD5PPSbits_t RD5PPSbits __at(0xF2D);

# 33489
extern volatile unsigned char RD6PPS __at(0xF2E);

asm("RD6PPS equ 0F2Eh");
...
extern volatile RD6PPSbits_t RD6PPSbits __at(0xF2E);

# 33539
extern volatile unsigned char RD7PPS __at(0xF2F);

asm("RD7PPS equ 0F2Fh");
...
extern volatile RD7PPSbits_t RD7PPSbits __at(0xF2F);

# 33589
extern volatile unsigned char RE0PPS __at(0xF30);

asm("RE0PPS equ 0F30h");
...
extern volatile RE0PPSbits_t RE0PPSbits __at(0xF30);

# 33639
extern volatile unsigned char RE1PPS __at(0xF31);

asm("RE1PPS equ 0F31h");
...
extern volatile RE1PPSbits_t RE1PPSbits __at(0xF31);

# 33689
extern volatile unsigned char RE2PPS __at(0xF32);

asm("RE2PPS equ 0F32h");
...
extern volatile RE2PPSbits_t RE2PPSbits __at(0xF32);
...
# 34855
extern volatile unsigned char CCDNB __at(0xF4B);
...
extern volatile CCDNBbits_t CCDNBbits __at(0xF4B);

# 34917
extern volatile unsigned char CCDPB __at(0xF4C);
...
extern volatile CCDPBbits_t CCDPBbits __at(0xF4C);

# 34979
extern volatile unsigned char ANSELC __at(0xF4E);

asm("ANSELC equ 0F4Eh");
...
extern volatile ANSELCbits_t ANSELCbits __at(0xF4E);
...
# 35103
extern volatile unsigned char ODCONC __at(0xF50);

asm("ODCONC equ 0F50h");
...
extern volatile ODCONCbits_t ODCONCbits __at(0xF50);

# 35165
extern volatile unsigned char SLRCONC __at(0xF51);

asm("SLRCONC equ 0F51h");
...
extern volatile SLRCONCbits_t SLRCONCbits __at(0xF51);
...
# 35475
extern volatile unsigned char CCDNC __at(0xF56);
...
extern volatile CCDNCbits_t CCDNCbits __at(0xF56);

# 35537
extern volatile unsigned char CCDPC __at(0xF57);
...
extern volatile CCDPCbits_t CCDPCbits __at(0xF57);

# 35599
extern volatile unsigned char ANSELD __at(0xF59);

asm("ANSELD equ 0F59h");
...
extern volatile ANSELDbits_t ANSELDbits __at(0xF59);

# 35661
extern volatile unsigned char WPUD __at(0xF5A);
...
extern volatile WPUDbits_t WPUDbits __at(0xF5A);

# 35723
extern volatile unsigned char ODCOND __at(0xF5B);

asm("ODCOND equ 0F5Bh");
...
extern volatile ODCONDbits_t ODCONDbits __at(0xF5B);

# 35785
extern volatile unsigned char SLRCOND __at(0xF5C);

asm("SLRCOND equ 0F5Ch");
...
extern volatile SLRCONDbits_t SLRCONDbits __at(0xF5C);

# 35847
extern volatile unsigned char INLVLD __at(0xF5D);

asm("INLVLD equ 0F5Dh");
...
extern volatile INLVLDbits_t INLVLDbits __at(0xF5D);

# 35909
extern volatile unsigned char CCDND __at(0xF61);
...
extern volatile CCDNDbits_t CCDNDbits __at(0xF61);

# 35971
extern volatile unsigned char CCDPD __at(0xF62);
...
extern volatile CCDPDbits_t CCDPDbits __at(0xF62);

# 36033
extern volatile unsigned char ANSELE __at(0xF64);

asm("ANSELE equ 0F64h");
...
extern volatile ANSELEbits_t ANSELEbits __at(0xF64);

# 36065
extern volatile unsigned char WPUE __at(0xF65);
...
extern volatile WPUEbits_t WPUEbits __at(0xF65);

# 36103
extern volatile unsigned char ODCONE __at(0xF66);

asm("ODCONE equ 0F66h");
...
extern volatile ODCONEbits_t ODCONEbits __at(0xF66);

# 36135
extern volatile unsigned char SLRCONE __at(0xF67);

asm("SLRCONE equ 0F67h");
...
extern volatile SLRCONEbits_t SLRCONEbits __at(0xF67);

# 36167
extern volatile unsigned char INLVLE __at(0xF68);

asm("INLVLE equ 0F68h");
...
extern volatile INLVLEbits_t INLVLEbits __at(0xF68);

# 36205
extern volatile unsigned char IOCEP __at(0xF69);
...
extern volatile IOCEPbits_t IOCEPbits __at(0xF69);

# 36226
extern volatile unsigned char IOCEN __at(0xF6A);
...
extern volatile IOCENbits_t IOCENbits __at(0xF6A);

# 36247
extern volatile unsigned char IOCEF __at(0xF6B);
...
extern volatile IOCEFbits_t IOCEFbits __at(0xF6B);

# 36268
extern volatile unsigned char CCDNE __at(0xF6C);
...
extern volatile CCDNEbits_t CCDNEbits __at(0xF6C);

# 36300
extern volatile unsigned char CCDPE __at(0xF6D);
...
extern volatile CCDPEbits_t CCDPEbits __at(0xF6D);
...
extern volatile __bit ADCACTPPS0 __at(0x7618);


extern volatile __bit ADCACTPPS1 __at(0x7619);


extern volatile __bit ADCACTPPS2 __at(0x761A);


extern volatile __bit ADCACTPPS3 __at(0x761B);


extern volatile __bit ADCACTPPS4 __at(0x761C);
...
extern volatile __bit ADFM1 __at(0x49B);


extern volatile __bit ADFRM0 __at(0x49A);


extern volatile __bit ADFRM1 __at(0x49B);
...
extern volatile __bit ANSA4 __at(0x79C4);


extern volatile __bit ANSA5 __at(0x79C5);


extern volatile __bit ANSA6 __at(0x79C6);


extern volatile __bit ANSA7 __at(0x79C7);


extern volatile __bit ANSB0 __at(0x7A18);


extern volatile __bit ANSB1 __at(0x7A19);


extern volatile __bit ANSB2 __at(0x7A1A);


extern volatile __bit ANSB3 __at(0x7A1B);


extern volatile __bit ANSB4 __at(0x7A1C);


extern volatile __bit ANSB5 __at(0x7A1D);


extern volatile __bit ANSB6 __at(0x7A1E);


extern volatile __bit ANSB7 __at(0x7A1F);


extern volatile __bit ANSC0 __at(0x7A70);


extern volatile __bit ANSC1 __at(0x7A71);


extern volatile __bit ANSC2 __at(0x7A72);


extern volatile __bit ANSC3 __at(0x7A73);


extern volatile __bit ANSC4 __at(0x7A74);


extern volatile __bit ANSC5 __at(0x7A75);


extern volatile __bit ANSC6 __at(0x7A76);


extern volatile __bit ANSC7 __at(0x7A77);


extern volatile __bit ANSD0 __at(0x7AC8);


extern volatile __bit ANSD1 __at(0x7AC9);


extern volatile __bit ANSD2 __at(0x7ACA);


extern volatile __bit ANSD3 __at(0x7ACB);


extern volatile __bit ANSD4 __at(0x7ACC);


extern volatile __bit ANSD5 __at(0x7ACD);


extern volatile __bit ANSD6 __at(0x7ACE);


extern volatile __bit ANSD7 __at(0x7ACF);


extern volatile __bit ANSE0 __at(0x7B20);


extern volatile __bit ANSE1 __at(0x7B21);


extern volatile __bit ANSE2 __at(0x7B22);
...
extern volatile __bit CCDNA0 __at(0x7A00);


extern volatile __bit CCDNA1 __at(0x7A01);


extern volatile __bit CCDNA2 __at(0x7A02);


extern volatile __bit CCDNA3 __at(0x7A03);


extern volatile __bit CCDNA4 __at(0x7A04);


extern volatile __bit CCDNA5 __at(0x7A05);


extern volatile __bit CCDNA6 __at(0x7A06);


extern volatile __bit CCDNA7 __at(0x7A07);


extern volatile __bit CCDNB0 __at(0x7A58);


extern volatile __bit CCDNB1 __at(0x7A59);


extern volatile __bit CCDNB2 __at(0x7A5A);


extern volatile __bit CCDNB3 __at(0x7A5B);


extern volatile __bit CCDNB4 __at(0x7A5C);


extern volatile __bit CCDNB5 __at(0x7A5D);


extern volatile __bit CCDNB6 __at(0x7A5E);


extern volatile __bit CCDNB7 __at(0x7A5F);


extern volatile __bit CCDNC0 __at(0x7AB0);


extern volatile __bit CCDNC1 __at(0x7AB1);


extern volatile __bit CCDNC2 __at(0x7AB2);


extern volatile __bit CCDNC3 __at(0x7AB3);


extern volatile __bit CCDNC4 __at(0x7AB4);


extern volatile __bit CCDNC5 __at(0x7AB5);


extern volatile __bit CCDNC6 __at(0x7AB6);


extern volatile __bit CCDNC7 __at(0x7AB7);


extern volatile __bit CCDND0 __at(0x7B08);


extern volatile __bit CCDND1 __at(0x7B09);


extern volatile __bit CCDND2 __at(0x7B0A);


extern volatile __bit CCDND3 __at(0x7B0B);


extern volatile __bit CCDND4 __at(0x7B0C);


extern volatile __bit CCDND5 __at(0x7B0D);


extern volatile __bit CCDND6 __at(0x7B0E);


extern volatile __bit CCDND7 __at(0x7B0F);


extern volatile __bit CCDNE0 __at(0x7B60);


extern volatile __bit CCDNE1 __at(0x7B61);


extern volatile __bit CCDNE2 __at(0x7B62);


extern volatile __bit CCDPA0 __at(0x7A08);


extern volatile __bit CCDPA1 __at(0x7A09);


extern volatile __bit CCDPA2 __at(0x7A0A);


extern volatile __bit CCDPA3 __at(0x7A0B);


extern volatile __bit CCDPA4 __at(0x7A0C);


extern volatile __bit CCDPA5 __at(0x7A0D);


extern volatile __bit CCDPA6 __at(0x7A0E);


extern volatile __bit CCDPA7 __at(0x7A0F);


extern volatile __bit CCDPB0 __at(0x7A60);


extern volatile __bit CCDPB1 __at(0x7A61);


extern volatile __bit CCDPB2 __at(0x7A62);


extern volatile __bit CCDPB3 __at(0x7A63);


extern volatile __bit CCDPB4 __at(0x7A64);


extern volatile __bit CCDPB5 __at(0x7A65);


extern volatile __bit CCDPB6 __at(0x7A66);


extern volatile __bit CCDPB7 __at(0x7A67);


extern volatile __bit CCDPC0 __at(0x7AB8);


extern volatile __bit CCDPC1 __at(0x7AB9);


extern volatile __bit CCDPC2 __at(0x7ABA);


extern volatile __bit CCDPC3 __at(0x7ABB);


extern volatile __bit CCDPC4 __at(0x7ABC);


extern volatile __bit CCDPC5 __at(0x7ABD);


extern volatile __bit CCDPC6 __at(0x7ABE);


extern volatile __bit CCDPC7 __at(0x7ABF);


extern volatile __bit CCDPD0 __at(0x7B10);


extern volatile __bit CCDPD1 __at(0x7B11);


extern volatile __bit CCDPD2 __at(0x7B12);


extern volatile __bit CCDPD3 __at(0x7B13);


extern volatile __bit CCDPD4 __at(0x7B14);


extern volatile __bit CCDPD5 __at(0x7B15);


extern volatile __bit CCDPD6 __at(0x7B16);


extern volatile __bit CCDPD7 __at(0x7B17);


extern volatile __bit CCDPE0 __at(0x7B68);


extern volatile __bit CCDPE1 __at(0x7B69);


extern volatile __bit CCDPE2 __at(0x7B6A);
...
extern volatile __bit CCP1PPS0 __at(0x7508);


extern volatile __bit CCP1PPS1 __at(0x7509);


extern volatile __bit CCP1PPS2 __at(0x750A);


extern volatile __bit CCP1PPS3 __at(0x750B);


extern volatile __bit CCP1PPS4 __at(0x750C);
...
extern volatile __bit CCP2PPS0 __at(0x7510);


extern volatile __bit CCP2PPS1 __at(0x7511);


extern volatile __bit CCP2PPS2 __at(0x7512);


extern volatile __bit CCP2PPS3 __at(0x7513);


extern volatile __bit CCP2PPS4 __at(0x7514);
...
extern volatile __bit CCP3PPS0 __at(0x7518);


extern volatile __bit CCP3PPS1 __at(0x7519);


extern volatile __bit CCP3PPS2 __at(0x751A);


extern volatile __bit CCP3PPS3 __at(0x751B);


extern volatile __bit CCP3PPS4 __at(0x751C);
...
extern volatile __bit CCP4PPS0 __at(0x7520);


extern volatile __bit CCP4PPS1 __at(0x7521);


extern volatile __bit CCP4PPS2 __at(0x7522);


extern volatile __bit CCP4PPS3 __at(0x7523);


extern volatile __bit CCP4PPS4 __at(0x7524);
...
extern volatile __bit CCP5PPS0 __at(0x7528);


extern volatile __bit CCP5PPS1 __at(0x7529);


extern volatile __bit CCP5PPS2 __at(0x752A);


extern volatile __bit CCP5PPS3 __at(0x752B);


extern volatile __bit CCP5PPS4 __at(0x752C);


extern volatile __bit CCP5PPS5 __at(0x752D);
...
extern volatile __bit CLCIN0PPS0 __at(0x75D8);


extern volatile __bit CLCIN0PPS1 __at(0x75D9);


extern volatile __bit CLCIN0PPS2 __at(0x75DA);


extern volatile __bit CLCIN0PPS3 __at(0x75DB);


extern volatile __bit CLCIN0PPS4 __at(0x75DC);


extern volatile __bit CLCIN1PPS0 __at(0x75E0);


extern volatile __bit CLCIN1PPS1 __at(0x75E1);


extern volatile __bit CLCIN1PPS2 __at(0x75E2);


extern volatile __bit CLCIN1PPS3 __at(0x75E3);


extern volatile __bit CLCIN1PPS4 __at(0x75E4);


extern volatile __bit CLCIN2PPS0 __at(0x75E8);


extern volatile __bit CLCIN2PPS1 __at(0x75E9);


extern volatile __bit CLCIN2PPS2 __at(0x75EA);


extern volatile __bit CLCIN2PPS3 __at(0x75EB);


extern volatile __bit CLCIN2PPS4 __at(0x75EC);


extern volatile __bit CLCIN3PPS0 __at(0x75F0);


extern volatile __bit CLCIN3PPS1 __at(0x75F1);


extern volatile __bit CLCIN3PPS2 __at(0x75F2);


extern volatile __bit CLCIN3PPS3 __at(0x75F3);


extern volatile __bit CLCIN3PPS4 __at(0x75F4);
...
extern volatile __bit CWG1PPS0 __at(0x7588);


extern volatile __bit CWG1PPS1 __at(0x7589);


extern volatile __bit CWG1PPS2 __at(0x758A);


extern volatile __bit CWG1PPS3 __at(0x758B);


extern volatile __bit CWG1PPS4 __at(0x758C);
...
extern volatile __bit CWG2PPS0 __at(0x7590);


extern volatile __bit CWG2PPS1 __at(0x7591);


extern volatile __bit CWG2PPS2 __at(0x7592);


extern volatile __bit CWG2PPS3 __at(0x7593);


extern volatile __bit CWG2PPS4 __at(0x7594);
...
extern volatile __bit CWG3PPS0 __at(0x7598);


extern volatile __bit CWG3PPS1 __at(0x7599);


extern volatile __bit CWG3PPS2 __at(0x759A);


extern volatile __bit CWG3PPS3 __at(0x759B);


extern volatile __bit CWG3PPS4 __at(0x759C);
...
extern volatile __bit INLVLA0 __at(0x79E0);


extern volatile __bit INLVLA1 __at(0x79E1);


extern volatile __bit INLVLA2 __at(0x79E2);


extern volatile __bit INLVLA3 __at(0x79E3);


extern volatile __bit INLVLA4 __at(0x79E4);


extern volatile __bit INLVLA5 __at(0x79E5);


extern volatile __bit INLVLA6 __at(0x79E6);


extern volatile __bit INLVLA7 __at(0x79E7);


extern volatile __bit INLVLB0 __at(0x7A38);


extern volatile __bit INLVLB1 __at(0x7A39);


extern volatile __bit INLVLB2 __at(0x7A3A);


extern volatile __bit INLVLB3 __at(0x7A3B);


extern volatile __bit INLVLB4 __at(0x7A3C);


extern volatile __bit INLVLB5 __at(0x7A3D);


extern volatile __bit INLVLB6 __at(0x7A3E);


extern volatile __bit INLVLB7 __at(0x7A3F);


extern volatile __bit INLVLC0 __at(0x7A90);


extern volatile __bit INLVLC1 __at(0x7A91);


extern volatile __bit INLVLC2 __at(0x7A92);


extern volatile __bit INLVLC3 __at(0x7A93);


extern volatile __bit INLVLC4 __at(0x7A94);


extern volatile __bit INLVLC5 __at(0x7A95);


extern volatile __bit INLVLC6 __at(0x7A96);


extern volatile __bit INLVLC7 __at(0x7A97);


extern volatile __bit INLVLD0 __at(0x7AE8);


extern volatile __bit INLVLD1 __at(0x7AE9);


extern volatile __bit INLVLD2 __at(0x7AEA);


extern volatile __bit INLVLD3 __at(0x7AEB);


extern volatile __bit INLVLD4 __at(0x7AEC);


extern volatile __bit INLVLD5 __at(0x7AED);


extern volatile __bit INLVLD6 __at(0x7AEE);


extern volatile __bit INLVLD7 __at(0x7AEF);


extern volatile __bit INLVLE0 __at(0x7B40);


extern volatile __bit INLVLE1 __at(0x7B41);


extern volatile __bit INLVLE2 __at(0x7B42);


extern volatile __bit INLVLE3 __at(0x7B43);
...
extern volatile __bit INTPPS0 __at(0x7480);


extern volatile __bit INTPPS1 __at(0x7481);


extern volatile __bit INTPPS2 __at(0x7482);


extern volatile __bit INTPPS3 __at(0x7483);


extern volatile __bit INVALID __at(0x2084);


extern volatile __bit IOCAF0 __at(0x79F8);


extern volatile __bit IOCAF1 __at(0x79F9);


extern volatile __bit IOCAF2 __at(0x79FA);


extern volatile __bit IOCAF3 __at(0x79FB);


extern volatile __bit IOCAF4 __at(0x79FC);


extern volatile __bit IOCAF5 __at(0x79FD);


extern volatile __bit IOCAF6 __at(0x79FE);


extern volatile __bit IOCAF7 __at(0x79FF);


extern volatile __bit IOCAN0 __at(0x79F0);


extern volatile __bit IOCAN1 __at(0x79F1);


extern volatile __bit IOCAN2 __at(0x79F2);


extern volatile __bit IOCAN3 __at(0x79F3);


extern volatile __bit IOCAN4 __at(0x79F4);


extern volatile __bit IOCAN5 __at(0x79F5);


extern volatile __bit IOCAN6 __at(0x79F6);


extern volatile __bit IOCAN7 __at(0x79F7);


extern volatile __bit IOCAP0 __at(0x79E8);


extern volatile __bit IOCAP1 __at(0x79E9);


extern volatile __bit IOCAP2 __at(0x79EA);


extern volatile __bit IOCAP3 __at(0x79EB);


extern volatile __bit IOCAP4 __at(0x79EC);


extern volatile __bit IOCAP5 __at(0x79ED);


extern volatile __bit IOCAP6 __at(0x79EE);


extern volatile __bit IOCAP7 __at(0x79EF);


extern volatile __bit IOCBF0 __at(0x7A50);


extern volatile __bit IOCBF1 __at(0x7A51);


extern volatile __bit IOCBF2 __at(0x7A52);


extern volatile __bit IOCBF3 __at(0x7A53);


extern volatile __bit IOCBF4 __at(0x7A54);


extern volatile __bit IOCBF5 __at(0x7A55);


extern volatile __bit IOCBF6 __at(0x7A56);


extern volatile __bit IOCBF7 __at(0x7A57);


extern volatile __bit IOCBN0 __at(0x7A48);


extern volatile __bit IOCBN1 __at(0x7A49);


extern volatile __bit IOCBN2 __at(0x7A4A);


extern volatile __bit IOCBN3 __at(0x7A4B);


extern volatile __bit IOCBN4 __at(0x7A4C);


extern volatile __bit IOCBN5 __at(0x7A4D);


extern volatile __bit IOCBN6 __at(0x7A4E);


extern volatile __bit IOCBN7 __at(0x7A4F);


extern volatile __bit IOCBP0 __at(0x7A40);


extern volatile __bit IOCBP1 __at(0x7A41);


extern volatile __bit IOCBP2 __at(0x7A42);


extern volatile __bit IOCBP3 __at(0x7A43);


extern volatile __bit IOCBP4 __at(0x7A44);


extern volatile __bit IOCBP5 __at(0x7A45);


extern volatile __bit IOCBP6 __at(0x7A46);


extern volatile __bit IOCBP7 __at(0x7A47);


extern volatile __bit IOCCF0 __at(0x7AA8);


extern volatile __bit IOCCF1 __at(0x7AA9);


extern volatile __bit IOCCF2 __at(0x7AAA);


extern volatile __bit IOCCF3 __at(0x7AAB);


extern volatile __bit IOCCF4 __at(0x7AAC);


extern volatile __bit IOCCF5 __at(0x7AAD);


extern volatile __bit IOCCF6 __at(0x7AAE);


extern volatile __bit IOCCF7 __at(0x7AAF);


extern volatile __bit IOCCN0 __at(0x7AA0);


extern volatile __bit IOCCN1 __at(0x7AA1);


extern volatile __bit IOCCN2 __at(0x7AA2);


extern volatile __bit IOCCN3 __at(0x7AA3);


extern volatile __bit IOCCN4 __at(0x7AA4);


extern volatile __bit IOCCN5 __at(0x7AA5);


extern volatile __bit IOCCN6 __at(0x7AA6);


extern volatile __bit IOCCN7 __at(0x7AA7);


extern volatile __bit IOCCP0 __at(0x7A98);


extern volatile __bit IOCCP1 __at(0x7A99);


extern volatile __bit IOCCP2 __at(0x7A9A);


extern volatile __bit IOCCP3 __at(0x7A9B);


extern volatile __bit IOCCP4 __at(0x7A9C);


extern volatile __bit IOCCP5 __at(0x7A9D);


extern volatile __bit IOCCP6 __at(0x7A9E);


extern volatile __bit IOCCP7 __at(0x7A9F);


extern volatile __bit IOCEF3 __at(0x7B5B);


extern volatile __bit IOCEN3 __at(0x7B53);


extern volatile __bit IOCEP3 __at(0x7B4B);
...
extern volatile __bit LC1D1S0 __at(0x7090);


extern volatile __bit LC1D1S1 __at(0x7091);


extern volatile __bit LC1D1S2 __at(0x7092);


extern volatile __bit LC1D1S3 __at(0x7093);


extern volatile __bit LC1D1S4 __at(0x7094);


extern volatile __bit LC1D1S5 __at(0x7095);


extern volatile __bit LC1D1S6 __at(0x7096);


extern volatile __bit LC1D1S7 __at(0x7097);


extern volatile __bit LC1D2S0 __at(0x7098);


extern volatile __bit LC1D2S1 __at(0x7099);


extern volatile __bit LC1D2S2 __at(0x709A);


extern volatile __bit LC1D2S3 __at(0x709B);


extern volatile __bit LC1D2S4 __at(0x709C);


extern volatile __bit LC1D2S5 __at(0x709D);


extern volatile __bit LC1D2S6 __at(0x709E);


extern volatile __bit LC1D2S7 __at(0x709F);


extern volatile __bit LC1D3S0 __at(0x70A0);


extern volatile __bit LC1D3S1 __at(0x70A1);


extern volatile __bit LC1D3S2 __at(0x70A2);


extern volatile __bit LC1D3S3 __at(0x70A3);


extern volatile __bit LC1D3S4 __at(0x70A4);


extern volatile __bit LC1D3S5 __at(0x70A5);


extern volatile __bit LC1D3S6 __at(0x70A6);


extern volatile __bit LC1D3S7 __at(0x70A7);


extern volatile __bit LC1D4S0 __at(0x70A8);


extern volatile __bit LC1D4S1 __at(0x70A9);


extern volatile __bit LC1D4S2 __at(0x70AA);


extern volatile __bit LC1D4S3 __at(0x70AB);


extern volatile __bit LC1D4S4 __at(0x70AC);


extern volatile __bit LC1D4S5 __at(0x70AD);


extern volatile __bit LC1D4S6 __at(0x70AE);


extern volatile __bit LC1D4S7 __at(0x70AF);


extern volatile __bit LC1EN __at(0x7087);


extern volatile __bit LC1G1D1N __at(0x70B0);


extern volatile __bit LC1G1D1T __at(0x70B1);


extern volatile __bit LC1G1D2N __at(0x70B2);


extern volatile __bit LC1G1D2T __at(0x70B3);


extern volatile __bit LC1G1D3N __at(0x70B4);


extern volatile __bit LC1G1D3T __at(0x70B5);


extern volatile __bit LC1G1D4N __at(0x70B6);


extern volatile __bit LC1G1D4T __at(0x70B7);


extern volatile __bit LC1G1POL __at(0x7088);


extern volatile __bit LC1G2D1N __at(0x70B8);


extern volatile __bit LC1G2D1T __at(0x70B9);


extern volatile __bit LC1G2D2N __at(0x70BA);


extern volatile __bit LC1G2D2T __at(0x70BB);


extern volatile __bit LC1G2D3N __at(0x70BC);


extern volatile __bit LC1G2D3T __at(0x70BD);


extern volatile __bit LC1G2D4N __at(0x70BE);


extern volatile __bit LC1G2D4T __at(0x70BF);


extern volatile __bit LC1G2POL __at(0x7089);


extern volatile __bit LC1G3D1N __at(0x70C0);


extern volatile __bit LC1G3D1T __at(0x70C1);


extern volatile __bit LC1G3D2N __at(0x70C2);


extern volatile __bit LC1G3D2T __at(0x70C3);


extern volatile __bit LC1G3D3N __at(0x70C4);


extern volatile __bit LC1G3D3T __at(0x70C5);


extern volatile __bit LC1G3D4N __at(0x70C6);


extern volatile __bit LC1G3D4T __at(0x70C7);


extern volatile __bit LC1G3POL __at(0x708A);


extern volatile __bit LC1G4D1N __at(0x70C8);


extern volatile __bit LC1G4D1T __at(0x70C9);


extern volatile __bit LC1G4D2N __at(0x70CA);


extern volatile __bit LC1G4D2T __at(0x70CB);


extern volatile __bit LC1G4D3N __at(0x70CC);


extern volatile __bit LC1G4D3T __at(0x70CD);


extern volatile __bit LC1G4D4N __at(0x70CE);


extern volatile __bit LC1G4D4T __at(0x70CF);


extern volatile __bit LC1G4POL __at(0x708B);


extern volatile __bit LC1INTN __at(0x7083);


extern volatile __bit LC1INTP __at(0x7084);


extern volatile __bit LC1MODE0 __at(0x7080);


extern volatile __bit LC1MODE1 __at(0x7081);


extern volatile __bit LC1MODE2 __at(0x7082);


extern volatile __bit LC1OUT __at(0x7085);


extern volatile __bit LC1POL __at(0x708F);


extern volatile __bit LC2D1S0 __at(0x70E0);


extern volatile __bit LC2D1S1 __at(0x70E1);


extern volatile __bit LC2D1S2 __at(0x70E2);


extern volatile __bit LC2D1S3 __at(0x70E3);


extern volatile __bit LC2D1S4 __at(0x70E4);


extern volatile __bit LC2D1S5 __at(0x70E5);


extern volatile __bit LC2D1S6 __at(0x70E6);


extern volatile __bit LC2D1S7 __at(0x70E7);


extern volatile __bit LC2D2S0 __at(0x70E8);


extern volatile __bit LC2D2S1 __at(0x70E9);


extern volatile __bit LC2D2S2 __at(0x70EA);


extern volatile __bit LC2D2S3 __at(0x70EB);


extern volatile __bit LC2D2S4 __at(0x70EC);


extern volatile __bit LC2D2S5 __at(0x70ED);


extern volatile __bit LC2D2S6 __at(0x70EE);


extern volatile __bit LC2D2S7 __at(0x70EF);


extern volatile __bit LC2D3S0 __at(0x70F0);


extern volatile __bit LC2D3S1 __at(0x70F1);


extern volatile __bit LC2D3S2 __at(0x70F2);


extern volatile __bit LC2D3S3 __at(0x70F3);


extern volatile __bit LC2D3S4 __at(0x70F4);


extern volatile __bit LC2D3S5 __at(0x70F5);


extern volatile __bit LC2D3S6 __at(0x70F6);


extern volatile __bit LC2D3S7 __at(0x70F7);


extern volatile __bit LC2D4S0 __at(0x70F8);


extern volatile __bit LC2D4S1 __at(0x70F9);


extern volatile __bit LC2D4S2 __at(0x70FA);


extern volatile __bit LC2D4S3 __at(0x70FB);


extern volatile __bit LC2D4S4 __at(0x70FC);


extern volatile __bit LC2D4S5 __at(0x70FD);


extern volatile __bit LC2D4S6 __at(0x70FE);


extern volatile __bit LC2D4S7 __at(0x70FF);


extern volatile __bit LC2EN __at(0x70D7);


extern volatile __bit LC2G1D1N __at(0x7100);


extern volatile __bit LC2G1D1T __at(0x7101);


extern volatile __bit LC2G1D2N __at(0x7102);


extern volatile __bit LC2G1D2T __at(0x7103);


extern volatile __bit LC2G1D3N __at(0x7104);


extern volatile __bit LC2G1D3T __at(0x7105);


extern volatile __bit LC2G1D4N __at(0x7106);


extern volatile __bit LC2G1D4T __at(0x7107);


extern volatile __bit LC2G1POL __at(0x70D8);


extern volatile __bit LC2G2D1N __at(0x7108);


extern volatile __bit LC2G2D1T __at(0x7109);


extern volatile __bit LC2G2D2N __at(0x710A);


extern volatile __bit LC2G2D2T __at(0x710B);


extern volatile __bit LC2G2D3N __at(0x710C);


extern volatile __bit LC2G2D3T __at(0x710D);


extern volatile __bit LC2G2D4N __at(0x710E);


extern volatile __bit LC2G2D4T __at(0x710F);


extern volatile __bit LC2G2POL __at(0x70D9);


extern volatile __bit LC2G3D1N __at(0x7110);


extern volatile __bit LC2G3D1T __at(0x7111);


extern volatile __bit LC2G3D2N __at(0x7112);


extern volatile __bit LC2G3D2T __at(0x7113);


extern volatile __bit LC2G3D3N __at(0x7114);


extern volatile __bit LC2G3D3T __at(0x7115);


extern volatile __bit LC2G3D4N __at(0x7116);


extern volatile __bit LC2G3D4T __at(0x7117);


extern volatile __bit LC2G3POL __at(0x70DA);


extern volatile __bit LC2G4D1N __at(0x7118);


extern volatile __bit LC2G4D1T __at(0x7119);


extern volatile __bit LC2G4D2N __at(0x711A);


extern volatile __bit LC2G4D2T __at(0x711B);


extern volatile __bit LC2G4D3N __at(0x711C);


extern volatile __bit LC2G4D3T __at(0x711D);


extern volatile __bit LC2G4D4N __at(0x711E);


extern volatile __bit LC2G4D4T __at(0x711F);


extern volatile __bit LC2G4POL __at(0x70DB);


extern volatile __bit LC2INTN __at(0x70D3);


extern volatile __bit LC2INTP __at(0x70D4);


extern volatile __bit LC2MODE0 __at(0x70D0);


extern volatile __bit LC2MODE1 __at(0x70D1);


extern volatile __bit LC2MODE2 __at(0x70D2);


extern volatile __bit LC2OUT __at(0x70D5);


extern volatile __bit LC2POL __at(0x70DF);


extern volatile __bit LC3D1S0 __at(0x7130);


extern volatile __bit LC3D1S1 __at(0x7131);


extern volatile __bit LC3D1S2 __at(0x7132);


extern volatile __bit LC3D1S3 __at(0x7133);


extern volatile __bit LC3D1S4 __at(0x7134);


extern volatile __bit LC3D1S5 __at(0x7135);


extern volatile __bit LC3D1S6 __at(0x7136);


extern volatile __bit LC3D1S7 __at(0x7137);


extern volatile __bit LC3D2S0 __at(0x7138);


extern volatile __bit LC3D2S1 __at(0x7139);


extern volatile __bit LC3D2S2 __at(0x713A);


extern volatile __bit LC3D2S3 __at(0x713B);


extern volatile __bit LC3D2S4 __at(0x713C);


extern volatile __bit LC3D2S5 __at(0x713D);


extern volatile __bit LC3D2S6 __at(0x713E);


extern volatile __bit LC3D2S7 __at(0x713F);


extern volatile __bit LC3D3S0 __at(0x7140);


extern volatile __bit LC3D3S1 __at(0x7141);


extern volatile __bit LC3D3S2 __at(0x7142);


extern volatile __bit LC3D3S3 __at(0x7143);


extern volatile __bit LC3D3S4 __at(0x7144);


extern volatile __bit LC3D3S5 __at(0x7145);


extern volatile __bit LC3D3S6 __at(0x7146);


extern volatile __bit LC3D3S7 __at(0x7147);


extern volatile __bit LC3D4S0 __at(0x7148);


extern volatile __bit LC3D4S1 __at(0x7149);


extern volatile __bit LC3D4S2 __at(0x714A);


extern volatile __bit LC3D4S3 __at(0x714B);


extern volatile __bit LC3D4S4 __at(0x714C);


extern volatile __bit LC3D4S5 __at(0x714D);


extern volatile __bit LC3D4S6 __at(0x714E);


extern volatile __bit LC3D4S7 __at(0x714F);


extern volatile __bit LC3EN __at(0x7127);


extern volatile __bit LC3G1D1N __at(0x7150);


extern volatile __bit LC3G1D1T __at(0x7151);


extern volatile __bit LC3G1D2N __at(0x7152);


extern volatile __bit LC3G1D2T __at(0x7153);


extern volatile __bit LC3G1D3N __at(0x7154);


extern volatile __bit LC3G1D3T __at(0x7155);


extern volatile __bit LC3G1D4N __at(0x7156);


extern volatile __bit LC3G1D4T __at(0x7157);


extern volatile __bit LC3G1POL __at(0x7128);


extern volatile __bit LC3G2D1N __at(0x7158);


extern volatile __bit LC3G2D1T __at(0x7159);


extern volatile __bit LC3G2D2N __at(0x715A);


extern volatile __bit LC3G2D2T __at(0x715B);


extern volatile __bit LC3G2D3N __at(0x715C);


extern volatile __bit LC3G2D3T __at(0x715D);


extern volatile __bit LC3G2D4N __at(0x715E);


extern volatile __bit LC3G2D4T __at(0x715F);


extern volatile __bit LC3G2POL __at(0x7129);


extern volatile __bit LC3G3D1N __at(0x7160);


extern volatile __bit LC3G3D1T __at(0x7161);


extern volatile __bit LC3G3D2N __at(0x7162);


extern volatile __bit LC3G3D2T __at(0x7163);


extern volatile __bit LC3G3D3N __at(0x7164);


extern volatile __bit LC3G3D3T __at(0x7165);


extern volatile __bit LC3G3D4N __at(0x7166);


extern volatile __bit LC3G3D4T __at(0x7167);


extern volatile __bit LC3G3POL __at(0x712A);


extern volatile __bit LC3G4D1N __at(0x7168);


extern volatile __bit LC3G4D1T __at(0x7169);


extern volatile __bit LC3G4D2N __at(0x716A);


extern volatile __bit LC3G4D2T __at(0x716B);


extern volatile __bit LC3G4D3N __at(0x716C);


extern volatile __bit LC3G4D3T __at(0x716D);


extern volatile __bit LC3G4D4N __at(0x716E);


extern volatile __bit LC3G4D4T __at(0x716F);


extern volatile __bit LC3G4POL __at(0x712B);


extern volatile __bit LC3INTN __at(0x7123);


extern volatile __bit LC3INTP __at(0x7124);


extern volatile __bit LC3MODE0 __at(0x7120);


extern volatile __bit LC3MODE1 __at(0x7121);


extern volatile __bit LC3MODE2 __at(0x7122);


extern volatile __bit LC3OUT __at(0x7125);


extern volatile __bit LC3POL __at(0x712F);


extern volatile __bit LC4D1S0 __at(0x7180);


extern volatile __bit LC4D1S1 __at(0x7181);


extern volatile __bit LC4D1S2 __at(0x7182);


extern volatile __bit LC4D1S3 __at(0x7183);


extern volatile __bit LC4D1S4 __at(0x7184);


extern volatile __bit LC4D1S5 __at(0x7185);


extern volatile __bit LC4D1S6 __at(0x7186);


extern volatile __bit LC4D1S7 __at(0x7187);


extern volatile __bit LC4D2S0 __at(0x7188);


extern volatile __bit LC4D2S1 __at(0x7189);


extern volatile __bit LC4D2S2 __at(0x718A);


extern volatile __bit LC4D2S3 __at(0x718B);


extern volatile __bit LC4D2S4 __at(0x718C);


extern volatile __bit LC4D2S5 __at(0x718D);


extern volatile __bit LC4D2S6 __at(0x718E);


extern volatile __bit LC4D2S7 __at(0x718F);


extern volatile __bit LC4D3S0 __at(0x7190);


extern volatile __bit LC4D3S1 __at(0x7191);


extern volatile __bit LC4D3S2 __at(0x7192);


extern volatile __bit LC4D3S3 __at(0x7193);


extern volatile __bit LC4D3S4 __at(0x7194);


extern volatile __bit LC4D3S5 __at(0x7195);


extern volatile __bit LC4D3S6 __at(0x7196);


extern volatile __bit LC4D3S7 __at(0x7197);


extern volatile __bit LC4D4S0 __at(0x7198);


extern volatile __bit LC4D4S1 __at(0x7199);


extern volatile __bit LC4D4S2 __at(0x719A);


extern volatile __bit LC4D4S3 __at(0x719B);


extern volatile __bit LC4D4S4 __at(0x719C);


extern volatile __bit LC4D4S5 __at(0x719D);


extern volatile __bit LC4D4S6 __at(0x719E);


extern volatile __bit LC4D4S7 __at(0x719F);


extern volatile __bit LC4EN __at(0x7177);


extern volatile __bit LC4G1D1N __at(0x71A0);


extern volatile __bit LC4G1D1T __at(0x71A1);


extern volatile __bit LC4G1D2N __at(0x71A2);


extern volatile __bit LC4G1D2T __at(0x71A3);


extern volatile __bit LC4G1D3N __at(0x71A4);


extern volatile __bit LC4G1D3T __at(0x71A5);


extern volatile __bit LC4G1D4N __at(0x71A6);


extern volatile __bit LC4G1D4T __at(0x71A7);


extern volatile __bit LC4G1POL __at(0x7178);


extern volatile __bit LC4G2D1N __at(0x71A8);


extern volatile __bit LC4G2D1T __at(0x71A9);


extern volatile __bit LC4G2D2N __at(0x71AA);


extern volatile __bit LC4G2D2T __at(0x71AB);


extern volatile __bit LC4G2D3N __at(0x71AC);


extern volatile __bit LC4G2D3T __at(0x71AD);


extern volatile __bit LC4G2D4N __at(0x71AE);


extern volatile __bit LC4G2D4T __at(0x71AF);


extern volatile __bit LC4G2POL __at(0x7179);


extern volatile __bit LC4G3D1N __at(0x71B0);


extern volatile __bit LC4G3D1T __at(0x71B1);


extern volatile __bit LC4G3D2N __at(0x71B2);


extern volatile __bit LC4G3D2T __at(0x71B3);


extern volatile __bit LC4G3D3N __at(0x71B4);


extern volatile __bit LC4G3D3T __at(0x71B5);


extern volatile __bit LC4G3D4N __at(0x71B6);


extern volatile __bit LC4G3D4T __at(0x71B7);


extern volatile __bit LC4G3POL __at(0x717A);


extern volatile __bit LC4G4D1N __at(0x71B8);


extern volatile __bit LC4G4D1T __at(0x71B9);


extern volatile __bit LC4G4D2N __at(0x71BA);


extern volatile __bit LC4G4D2T __at(0x71BB);


extern volatile __bit LC4G4D3N __at(0x71BC);


extern volatile __bit LC4G4D3T __at(0x71BD);


extern volatile __bit LC4G4D4N __at(0x71BE);


extern volatile __bit LC4G4D4T __at(0x71BF);


extern volatile __bit LC4G4POL __at(0x717B);


extern volatile __bit LC4INTN __at(0x7173);


extern volatile __bit LC4INTP __at(0x7174);


extern volatile __bit LC4MODE0 __at(0x7170);


extern volatile __bit LC4MODE1 __at(0x7171);


extern volatile __bit LC4MODE2 __at(0x7172);


extern volatile __bit LC4OUT __at(0x7175);


extern volatile __bit LC4POL __at(0x717F);
...
extern volatile __bit MDCARHPPS0 __at(0x75C8);


extern volatile __bit MDCARHPPS1 __at(0x75C9);


extern volatile __bit MDCARHPPS2 __at(0x75CA);


extern volatile __bit MDCARHPPS3 __at(0x75CB);


extern volatile __bit MDCARHPPS4 __at(0x75CC);


extern volatile __bit MDCARLPPS0 __at(0x75C0);


extern volatile __bit MDCARLPPS1 __at(0x75C1);


extern volatile __bit MDCARLPPS2 __at(0x75C2);


extern volatile __bit MDCARLPPS3 __at(0x75C3);


extern volatile __bit MDCARLPPS4 __at(0x75C4);
...
extern volatile __bit MDSRCPPS0 __at(0x75D0);


extern volatile __bit MDSRCPPS1 __at(0x75D1);


extern volatile __bit MDSRCPPS2 __at(0x75D2);


extern volatile __bit MDSRCPPS3 __at(0x75D3);


extern volatile __bit MDSRCPPS4 __at(0x75D4);
...
extern volatile __bit MLC1OUT __at(0x7078);


extern volatile __bit MLC2OUT __at(0x7079);


extern volatile __bit MLC3OUT __at(0x707A);


extern volatile __bit MLC4OUT __at(0x707B);
...
extern volatile __bit ODCA0 __at(0x79D0);


extern volatile __bit ODCA1 __at(0x79D1);


extern volatile __bit ODCA2 __at(0x79D2);


extern volatile __bit ODCA3 __at(0x79D3);


extern volatile __bit ODCA4 __at(0x79D4);


extern volatile __bit ODCA5 __at(0x79D5);


extern volatile __bit ODCA6 __at(0x79D6);


extern volatile __bit ODCA7 __at(0x79D7);


extern volatile __bit ODCB0 __at(0x7A28);


extern volatile __bit ODCB1 __at(0x7A29);


extern volatile __bit ODCB2 __at(0x7A2A);


extern volatile __bit ODCB3 __at(0x7A2B);


extern volatile __bit ODCB4 __at(0x7A2C);


extern volatile __bit ODCB5 __at(0x7A2D);


extern volatile __bit ODCB6 __at(0x7A2E);


extern volatile __bit ODCB7 __at(0x7A2F);


extern volatile __bit ODCC0 __at(0x7A80);


extern volatile __bit ODCC1 __at(0x7A81);


extern volatile __bit ODCC2 __at(0x7A82);


extern volatile __bit ODCC3 __at(0x7A83);


extern volatile __bit ODCC4 __at(0x7A84);


extern volatile __bit ODCC5 __at(0x7A85);


extern volatile __bit ODCC6 __at(0x7A86);


extern volatile __bit ODCC7 __at(0x7A87);


extern volatile __bit ODCD0 __at(0x7AD8);


extern volatile __bit ODCD1 __at(0x7AD9);


extern volatile __bit ODCD2 __at(0x7ADA);


extern volatile __bit ODCD3 __at(0x7ADB);


extern volatile __bit ODCD4 __at(0x7ADC);


extern volatile __bit ODCD5 __at(0x7ADD);


extern volatile __bit ODCD6 __at(0x7ADE);


extern volatile __bit ODCD7 __at(0x7ADF);


extern volatile __bit ODCE0 __at(0x7B30);


extern volatile __bit ODCE1 __at(0x7B31);


extern volatile __bit ODCE2 __at(0x7B32);
...
extern volatile __bit P5M1 __at(0x18F7);
...
extern volatile __bit PPSLOCKED __at(0x7478);
...
extern volatile __bit RA0PPS0 __at(0x7880);


extern volatile __bit RA0PPS1 __at(0x7881);


extern volatile __bit RA0PPS2 __at(0x7882);


extern volatile __bit RA0PPS3 __at(0x7883);


extern volatile __bit RA0PPS4 __at(0x7884);


extern volatile __bit RA0PPS5 __at(0x7885);


extern volatile __bit RA1 __at(0x61);


extern volatile __bit RA1PPS0 __at(0x7888);


extern volatile __bit RA1PPS1 __at(0x7889);


extern volatile __bit RA1PPS2 __at(0x788A);


extern volatile __bit RA1PPS3 __at(0x788B);


extern volatile __bit RA1PPS4 __at(0x788C);


extern volatile __bit RA1PPS5 __at(0x788D);


extern volatile __bit RA2 __at(0x62);


extern volatile __bit RA2PPS0 __at(0x7890);


extern volatile __bit RA2PPS1 __at(0x7891);


extern volatile __bit RA2PPS2 __at(0x7892);


extern volatile __bit RA2PPS3 __at(0x7893);


extern volatile __bit RA2PPS4 __at(0x7894);


extern volatile __bit RA2PPS5 __at(0x7895);


extern volatile __bit RA3 __at(0x63);


extern volatile __bit RA3PPS0 __at(0x7898);


extern volatile __bit RA3PPS1 __at(0x7899);


extern volatile __bit RA3PPS2 __at(0x789A);


extern volatile __bit RA3PPS3 __at(0x789B);


extern volatile __bit RA3PPS4 __at(0x789C);


extern volatile __bit RA3PPS5 __at(0x789D);


extern volatile __bit RA4 __at(0x64);


extern volatile __bit RA4PPS0 __at(0x78A0);


extern volatile __bit RA4PPS1 __at(0x78A1);


extern volatile __bit RA4PPS2 __at(0x78A2);


extern volatile __bit RA4PPS3 __at(0x78A3);


extern volatile __bit RA4PPS4 __at(0x78A4);


extern volatile __bit RA4PPS5 __at(0x78A5);


extern volatile __bit RA5 __at(0x65);


extern volatile __bit RA5PPS0 __at(0x78A8);


extern volatile __bit RA5PPS1 __at(0x78A9);


extern volatile __bit RA5PPS2 __at(0x78AA);


extern volatile __bit RA5PPS3 __at(0x78AB);


extern volatile __bit RA5PPS4 __at(0x78AC);


extern volatile __bit RA5PPS5 __at(0x78AD);


extern volatile __bit RA6 __at(0x66);


extern volatile __bit RA6PPS0 __at(0x78B0);


extern volatile __bit RA6PPS1 __at(0x78B1);


extern volatile __bit RA6PPS2 __at(0x78B2);


extern volatile __bit RA6PPS3 __at(0x78B3);


extern volatile __bit RA6PPS4 __at(0x78B4);


extern volatile __bit RA6PPS5 __at(0x78B5);


extern volatile __bit RA7 __at(0x67);


extern volatile __bit RA7PPS0 __at(0x78B8);


extern volatile __bit RA7PPS1 __at(0x78B9);


extern volatile __bit RA7PPS2 __at(0x78BA);


extern volatile __bit RA7PPS3 __at(0x78BB);


extern volatile __bit RA7PPS4 __at(0x78BC);


extern volatile __bit RA7PPS5 __at(0x78BD);


extern volatile __bit RB0 __at(0x68);


extern volatile __bit RB0PPS0 __at(0x78C0);


extern volatile __bit RB0PPS1 __at(0x78C1);


extern volatile __bit RB0PPS2 __at(0x78C2);


extern volatile __bit RB0PPS3 __at(0x78C3);


extern volatile __bit RB0PPS4 __at(0x78C4);


extern volatile __bit RB0PPS5 __at(0x78C5);


extern volatile __bit RB1 __at(0x69);


extern volatile __bit RB1PPS0 __at(0x78C8);


extern volatile __bit RB1PPS1 __at(0x78C9);


extern volatile __bit RB1PPS2 __at(0x78CA);


extern volatile __bit RB1PPS3 __at(0x78CB);


extern volatile __bit RB1PPS4 __at(0x78CC);


extern volatile __bit RB1PPS5 __at(0x78CD);


extern volatile __bit RB2 __at(0x6A);


extern volatile __bit RB2PPS0 __at(0x78D0);


extern volatile __bit RB2PPS1 __at(0x78D1);


extern volatile __bit RB2PPS2 __at(0x78D2);


extern volatile __bit RB2PPS3 __at(0x78D3);


extern volatile __bit RB2PPS4 __at(0x78D4);


extern volatile __bit RB2PPS5 __at(0x78D5);


extern volatile __bit RB3 __at(0x6B);


extern volatile __bit RB3PPS0 __at(0x78D8);


extern volatile __bit RB3PPS1 __at(0x78D9);


extern volatile __bit RB3PPS2 __at(0x78DA);


extern volatile __bit RB3PPS3 __at(0x78DB);


extern volatile __bit RB3PPS4 __at(0x78DC);


extern volatile __bit RB3PPS5 __at(0x78DD);


extern volatile __bit RB4 __at(0x6C);


extern volatile __bit RB4PPS0 __at(0x78E0);


extern volatile __bit RB4PPS1 __at(0x78E1);


extern volatile __bit RB4PPS2 __at(0x78E2);


extern volatile __bit RB4PPS3 __at(0x78E3);


extern volatile __bit RB4PPS4 __at(0x78E4);


extern volatile __bit RB4PPS5 __at(0x78E5);


extern volatile __bit RB5 __at(0x6D);


extern volatile __bit RB5PPS0 __at(0x78E8);


extern volatile __bit RB5PPS1 __at(0x78E9);


extern volatile __bit RB5PPS2 __at(0x78EA);


extern volatile __bit RB5PPS3 __at(0x78EB);


extern volatile __bit RB5PPS4 __at(0x78EC);


extern volatile __bit RB5PPS5 __at(0x78ED);


extern volatile __bit RB6 __at(0x6E);


extern volatile __bit RB6PPS0 __at(0x78F0);


extern volatile __bit RB6PPS1 __at(0x78F1);


extern volatile __bit RB6PPS2 __at(0x78F2);


extern volatile __bit RB6PPS3 __at(0x78F3);


extern volatile __bit RB6PPS4 __at(0x78F4);


extern volatile __bit RB6PPS5 __at(0x78F5);


extern volatile __bit RB7 __at(0x6F);


extern volatile __bit RB7PPS0 __at(0x78F8);


extern volatile __bit RB7PPS1 __at(0x78F9);


extern volatile __bit RB7PPS2 __at(0x78FA);


extern volatile __bit RB7PPS3 __at(0x78FB);


extern volatile __bit RB7PPS4 __at(0x78FC);


extern volatile __bit RB7PPS5 __at(0x78FD);


extern volatile __bit RC0 __at(0x70);


extern volatile __bit RC0PPS0 __at(0x7900);


extern volatile __bit RC0PPS1 __at(0x7901);


extern volatile __bit RC0PPS2 __at(0x7902);


extern volatile __bit RC0PPS3 __at(0x7903);


extern volatile __bit RC0PPS4 __at(0x7904);


extern volatile __bit RC0PPS5 __at(0x7905);


extern volatile __bit RC1 __at(0x71);


extern volatile __bit RC1PPS0 __at(0x7908);


extern volatile __bit RC1PPS1 __at(0x7909);


extern volatile __bit RC1PPS2 __at(0x790A);


extern volatile __bit RC1PPS3 __at(0x790B);


extern volatile __bit RC1PPS4 __at(0x790C);


extern volatile __bit RC1PPS5 __at(0x790D);


extern volatile __bit RC2 __at(0x72);


extern volatile __bit RC2PPS0 __at(0x7910);


extern volatile __bit RC2PPS1 __at(0x7911);


extern volatile __bit RC2PPS2 __at(0x7912);


extern volatile __bit RC2PPS3 __at(0x7913);


extern volatile __bit RC2PPS4 __at(0x7914);


extern volatile __bit RC2PPS5 __at(0x7915);


extern volatile __bit RC3 __at(0x73);


extern volatile __bit RC3PPS0 __at(0x7918);


extern volatile __bit RC3PPS1 __at(0x7919);


extern volatile __bit RC3PPS2 __at(0x791A);


extern volatile __bit RC3PPS3 __at(0x791B);


extern volatile __bit RC3PPS4 __at(0x791C);


extern volatile __bit RC3PPS5 __at(0x791D);


extern volatile __bit RC4 __at(0x74);


extern volatile __bit RC4PPS0 __at(0x7920);


extern volatile __bit RC4PPS1 __at(0x7921);


extern volatile __bit RC4PPS2 __at(0x7922);


extern volatile __bit RC4PPS3 __at(0x7923);


extern volatile __bit RC4PPS4 __at(0x7924);


extern volatile __bit RC4PPS5 __at(0x7925);


extern volatile __bit RC5 __at(0x75);


extern volatile __bit RC5PPS0 __at(0x7928);


extern volatile __bit RC5PPS1 __at(0x7929);


extern volatile __bit RC5PPS2 __at(0x792A);


extern volatile __bit RC5PPS3 __at(0x792B);


extern volatile __bit RC5PPS4 __at(0x792C);


extern volatile __bit RC5PPS5 __at(0x792D);


extern volatile __bit RC6 __at(0x76);


extern volatile __bit RC6PPS0 __at(0x7930);


extern volatile __bit RC6PPS1 __at(0x7931);


extern volatile __bit RC6PPS2 __at(0x7932);


extern volatile __bit RC6PPS3 __at(0x7933);


extern volatile __bit RC6PPS4 __at(0x7934);


extern volatile __bit RC6PPS5 __at(0x7935);


extern volatile __bit RC7 __at(0x77);


extern volatile __bit RC7PPS0 __at(0x7938);


extern volatile __bit RC7PPS1 __at(0x7939);


extern volatile __bit RC7PPS2 __at(0x793A);


extern volatile __bit RC7PPS3 __at(0x793B);


extern volatile __bit RC7PPS4 __at(0x793C);


extern volatile __bit RC7PPS5 __at(0x793D);
...
extern volatile __bit RD0PPS0 __at(0x7940);


extern volatile __bit RD0PPS1 __at(0x7941);


extern volatile __bit RD0PPS2 __at(0x7942);


extern volatile __bit RD0PPS3 __at(0x7943);


extern volatile __bit RD0PPS4 __at(0x7944);


extern volatile __bit RD0PPS5 __at(0x7945);
...
extern volatile __bit RD1PPS0 __at(0x7948);


extern volatile __bit RD1PPS1 __at(0x7949);


extern volatile __bit RD1PPS2 __at(0x794A);


extern volatile __bit RD1PPS3 __at(0x794B);


extern volatile __bit RD1PPS4 __at(0x794C);


extern volatile __bit RD1PPS5 __at(0x794D);


extern volatile __bit RD2 __at(0x7A);


extern volatile __bit RD2PPS0 __at(0x7950);


extern volatile __bit RD2PPS1 __at(0x7951);


extern volatile __bit RD2PPS2 __at(0x7952);


extern volatile __bit RD2PPS3 __at(0x7953);


extern volatile __bit RD2PPS4 __at(0x7954);


extern volatile __bit RD2PPS5 __at(0x7955);


extern volatile __bit RD3 __at(0x7B);


extern volatile __bit RD3PPS0 __at(0x7958);


extern volatile __bit RD3PPS1 __at(0x7959);


extern volatile __bit RD3PPS2 __at(0x795A);


extern volatile __bit RD3PPS3 __at(0x795B);


extern volatile __bit RD3PPS4 __at(0x795C);


extern volatile __bit RD3PPS5 __at(0x795D);


extern volatile __bit RD4 __at(0x7C);


extern volatile __bit RD4PPS0 __at(0x7960);


extern volatile __bit RD4PPS1 __at(0x7961);


extern volatile __bit RD4PPS2 __at(0x7962);


extern volatile __bit RD4PPS3 __at(0x7963);


extern volatile __bit RD4PPS4 __at(0x7964);


extern volatile __bit RD4PPS5 __at(0x7965);


extern volatile __bit RD5 __at(0x7D);


extern volatile __bit RD5PPS0 __at(0x7968);


extern volatile __bit RD5PPS1 __at(0x7969);


extern volatile __bit RD5PPS2 __at(0x796A);


extern volatile __bit RD5PPS3 __at(0x796B);


extern volatile __bit RD5PPS4 __at(0x796C);


extern volatile __bit RD5PPS5 __at(0x796D);


extern volatile __bit RD6 __at(0x7E);


extern volatile __bit RD6PPS0 __at(0x7970);


extern volatile __bit RD6PPS1 __at(0x7971);


extern volatile __bit RD6PPS2 __at(0x7972);


extern volatile __bit RD6PPS3 __at(0x7973);


extern volatile __bit RD6PPS4 __at(0x7974);


extern volatile __bit RD6PPS5 __at(0x7975);


extern volatile __bit RD7 __at(0x7F);


extern volatile __bit RD7PPS0 __at(0x7978);


extern volatile __bit RD7PPS1 __at(0x7979);


extern volatile __bit RD7PPS2 __at(0x797A);


extern volatile __bit RD7PPS3 __at(0x797B);


extern volatile __bit RD7PPS4 __at(0x797C);


extern volatile __bit RD7PPS5 __at(0x797D);


extern volatile __bit RE0 __at(0x80);


extern volatile __bit RE0PPS0 __at(0x7980);


extern volatile __bit RE0PPS1 __at(0x7981);


extern volatile __bit RE0PPS2 __at(0x7982);


extern volatile __bit RE0PPS3 __at(0x7983);


extern volatile __bit RE0PPS4 __at(0x7984);


extern volatile __bit RE0PPS5 __at(0x7985);


extern volatile __bit RE1 __at(0x81);


extern volatile __bit RE1PPS0 __at(0x7988);


extern volatile __bit RE1PPS1 __at(0x7989);


extern volatile __bit RE1PPS2 __at(0x798A);


extern volatile __bit RE1PPS3 __at(0x798B);


extern volatile __bit RE1PPS4 __at(0x798C);


extern volatile __bit RE1PPS5 __at(0x798D);


extern volatile __bit RE2 __at(0x82);


extern volatile __bit RE2PPS0 __at(0x7990);


extern volatile __bit RE2PPS1 __at(0x7991);


extern volatile __bit RE2PPS2 __at(0x7992);


extern volatile __bit RE2PPS3 __at(0x7993);


extern volatile __bit RE2PPS4 __at(0x7994);


extern volatile __bit RE2PPS5 __at(0x7995);
...
extern volatile __bit RXPPS0 __at(0x7658);


extern volatile __bit RXPPS1 __at(0x7659);


extern volatile __bit RXPPS2 __at(0x765A);


extern volatile __bit RXPPS3 __at(0x765B);


extern volatile __bit RXPPS4 __at(0x765C);
...
extern volatile __bit SLRA0 __at(0x79D8);


extern volatile __bit SLRA1 __at(0x79D9);


extern volatile __bit SLRA2 __at(0x79DA);


extern volatile __bit SLRA3 __at(0x79DB);


extern volatile __bit SLRA4 __at(0x79DC);


extern volatile __bit SLRA5 __at(0x79DD);


extern volatile __bit SLRA6 __at(0x79DE);


extern volatile __bit SLRA7 __at(0x79DF);


extern volatile __bit SLRB0 __at(0x7A30);


extern volatile __bit SLRB1 __at(0x7A31);


extern volatile __bit SLRB2 __at(0x7A32);


extern volatile __bit SLRB3 __at(0x7A33);


extern volatile __bit SLRB4 __at(0x7A34);


extern volatile __bit SLRB5 __at(0x7A35);


extern volatile __bit SLRB6 __at(0x7A36);


extern volatile __bit SLRB7 __at(0x7A37);


extern volatile __bit SLRC0 __at(0x7A88);


extern volatile __bit SLRC1 __at(0x7A89);


extern volatile __bit SLRC2 __at(0x7A8A);


extern volatile __bit SLRC3 __at(0x7A8B);


extern volatile __bit SLRC4 __at(0x7A8C);


extern volatile __bit SLRC5 __at(0x7A8D);


extern volatile __bit SLRC6 __at(0x7A8E);


extern volatile __bit SLRC7 __at(0x7A8F);


extern volatile __bit SLRD0 __at(0x7AE0);


extern volatile __bit SLRD1 __at(0x7AE1);


extern volatile __bit SLRD2 __at(0x7AE2);


extern volatile __bit SLRD3 __at(0x7AE3);


extern volatile __bit SLRD4 __at(0x7AE4);


extern volatile __bit SLRD5 __at(0x7AE5);


extern volatile __bit SLRD6 __at(0x7AE6);


extern volatile __bit SLRD7 __at(0x7AE7);


extern volatile __bit SLRE0 __at(0x7B38);


extern volatile __bit SLRE1 __at(0x7B39);


extern volatile __bit SLRE2 __at(0x7B3A);
...
extern volatile __bit SMU1SIGPPS0 __at(0x7550);


extern volatile __bit SMU1SIGPPS1 __at(0x7551);


extern volatile __bit SMU1SIGPPS2 __at(0x7552);


extern volatile __bit SMU1SIGPPS3 __at(0x7553);


extern volatile __bit SMU1SIGPPS4 __at(0x7554);


extern volatile __bit SMU1WINPPS0 __at(0x7548);


extern volatile __bit SMU1WINPPS1 __at(0x7549);


extern volatile __bit SMU1WINPPS2 __at(0x754A);


extern volatile __bit SMU1WINPPS3 __at(0x754B);


extern volatile __bit SMU1WINPPS4 __at(0x754C);


extern volatile __bit SMU2SIGPPS0 __at(0x7560);


extern volatile __bit SMU2SIGPPS1 __at(0x7561);


extern volatile __bit SMU2SIGPPS2 __at(0x7562);


extern volatile __bit SMU2SIGPPS3 __at(0x7563);


extern volatile __bit SMU2SIGPPS4 __at(0x7564);


extern volatile __bit SMU2WINPPS0 __at(0x7558);


extern volatile __bit SMU2WINPPS1 __at(0x7559);


extern volatile __bit SMU2WINPPS2 __at(0x755A);


extern volatile __bit SMU2WINPPS3 __at(0x755B);


extern volatile __bit SMU2WINPPS4 __at(0x755C);
...
extern volatile __bit SSP1CLKPPS0 __at(0x7628);


extern volatile __bit SSP1CLKPPS1 __at(0x7629);


extern volatile __bit SSP1CLKPPS2 __at(0x762A);


extern volatile __bit SSP1CLKPPS3 __at(0x762B);


extern volatile __bit SSP1CLKPPS4 __at(0x762C);


extern volatile __bit SSP1DATPPS0 __at(0x7630);


extern volatile __bit SSP1DATPPS1 __at(0x7631);


extern volatile __bit SSP1DATPPS2 __at(0x7632);


extern volatile __bit SSP1DATPPS3 __at(0x7633);


extern volatile __bit SSP1DATPPS4 __at(0x7634);
...
extern volatile __bit SSP1SSPPS0 __at(0x7638);


extern volatile __bit SSP1SSPPS1 __at(0x7639);


extern volatile __bit SSP1SSPPS2 __at(0x763A);


extern volatile __bit SSP1SSPPS3 __at(0x763B);


extern volatile __bit SSP1SSPPS4 __at(0x763C);


extern volatile __bit SSP2CLKPPS0 __at(0x7640);


extern volatile __bit SSP2CLKPPS1 __at(0x7641);


extern volatile __bit SSP2CLKPPS2 __at(0x7642);


extern volatile __bit SSP2CLKPPS3 __at(0x7643);


extern volatile __bit SSP2CLKPPS4 __at(0x7644);


extern volatile __bit SSP2DATPPS0 __at(0x7648);


extern volatile __bit SSP2DATPPS1 __at(0x7649);


extern volatile __bit SSP2DATPPS2 __at(0x764A);


extern volatile __bit SSP2DATPPS3 __at(0x764B);


extern volatile __bit SSP2DATPPS4 __at(0x764C);
...
extern volatile __bit SSP2SSPPS0 __at(0x7650);


extern volatile __bit SSP2SSPPS1 __at(0x7651);


extern volatile __bit SSP2SSPPS2 __at(0x7652);


extern volatile __bit SSP2SSPPS3 __at(0x7653);


extern volatile __bit SSP2SSPPS4 __at(0x7654);
...
extern volatile __bit T0CKIPPS0 __at(0x7488);


extern volatile __bit T0CKIPPS1 __at(0x7489);


extern volatile __bit T0CKIPPS2 __at(0x748A);


extern volatile __bit T0CKIPPS3 __at(0x748B);
...
extern volatile __bit T1CKIPPS0 __at(0x7490);


extern volatile __bit T1CKIPPS1 __at(0x7491);


extern volatile __bit T1CKIPPS2 __at(0x7492);


extern volatile __bit T1CKIPPS3 __at(0x7493);


extern volatile __bit T1CKIPPS4 __at(0x7494);
...
extern volatile __bit T1GPPS0 __at(0x7498);


extern volatile __bit T1GPPS1 __at(0x7499);


extern volatile __bit T1GPPS2 __at(0x749A);


extern volatile __bit T1GPPS3 __at(0x749B);


extern volatile __bit T1GPPS4 __at(0x749C);
...
extern volatile __bit T2AINPPS0 __at(0x74E0);


extern volatile __bit T2AINPPS1 __at(0x74E1);


extern volatile __bit T2AINPPS2 __at(0x74E2);


extern volatile __bit T2AINPPS3 __at(0x74E3);


extern volatile __bit T2AINPPS4 __at(0x74E4);
...
extern volatile __bit T3CKIPPS0 __at(0x74A0);


extern volatile __bit T3CKIPPS1 __at(0x74A1);


extern volatile __bit T3CKIPPS2 __at(0x74A2);


extern volatile __bit T3CKIPPS3 __at(0x74A3);


extern volatile __bit T3CKIPPS4 __at(0x74A4);
...
extern volatile __bit T3GPPS0 __at(0x74A8);


extern volatile __bit T3GPPS1 __at(0x74A9);


extern volatile __bit T3GPPS2 __at(0x74AA);


extern volatile __bit T3GPPS3 __at(0x74AB);


extern volatile __bit T3GPPS4 __at(0x74AC);
...
extern volatile __bit T4AINPPS0 __at(0x74E8);


extern volatile __bit T4AINPPS1 __at(0x74E9);


extern volatile __bit T4AINPPS2 __at(0x74EA);


extern volatile __bit T4AINPPS3 __at(0x74EB);


extern volatile __bit T4AINPPS4 __at(0x74EC);
...
extern volatile __bit T5CKIPPS0 __at(0x74B0);


extern volatile __bit T5CKIPPS1 __at(0x74B1);


extern volatile __bit T5CKIPPS2 __at(0x74B2);


extern volatile __bit T5CKIPPS3 __at(0x74B3);


extern volatile __bit T5CKIPPS4 __at(0x74B4);
...
extern volatile __bit T5GPPS0 __at(0x74B8);


extern volatile __bit T5GPPS1 __at(0x74B9);


extern volatile __bit T5GPPS2 __at(0x74BA);


extern volatile __bit T5GPPS3 __at(0x74BB);


extern volatile __bit T5GPPS4 __at(0x74BC);
...
extern volatile __bit T6AINPPS0 __at(0x74F0);


extern volatile __bit T6AINPPS1 __at(0x74F1);


extern volatile __bit T6AINPPS2 __at(0x74F2);


extern volatile __bit T6AINPPS3 __at(0x74F3);


extern volatile __bit T6AINPPS4 __at(0x74F4);
...
extern volatile __bit TXPPS0 __at(0x7660);


extern volatile __bit TXPPS1 __at(0x7661);


extern volatile __bit TXPPS2 __at(0x7662);


extern volatile __bit TXPPS3 __at(0x7663);


extern volatile __bit TXPPS4 __at(0x7664);
...
extern volatile __bit VREGPM0 __at(0x4090);


extern volatile __bit VREGPM1 __at(0x4091);
...
extern volatile __bit WPUA0 __at(0x79C8);


extern volatile __bit WPUA1 __at(0x79C9);


extern volatile __bit WPUA2 __at(0x79CA);


extern volatile __bit WPUA3 __at(0x79CB);


extern volatile __bit WPUA4 __at(0x79CC);


extern volatile __bit WPUA5 __at(0x79CD);


extern volatile __bit WPUA6 __at(0x79CE);


extern volatile __bit WPUA7 __at(0x79CF);


extern volatile __bit WPUB0 __at(0x7A20);


extern volatile __bit WPUB1 __at(0x7A21);


extern volatile __bit WPUB2 __at(0x7A22);


extern volatile __bit WPUB3 __at(0x7A23);


extern volatile __bit WPUB4 __at(0x7A24);


extern volatile __bit WPUB5 __at(0x7A25);


extern volatile __bit WPUB6 __at(0x7A26);


extern volatile __bit WPUB7 __at(0x7A27);


extern volatile __bit WPUC0 __at(0x7A78);


extern volatile __bit WPUC1 __at(0x7A79);


extern volatile __bit WPUC2 __at(0x7A7A);


extern volatile __bit WPUC3 __at(0x7A7B);


extern volatile __bit WPUC4 __at(0x7A7C);


extern volatile __bit WPUC5 __at(0x7A7D);


extern volatile __bit WPUC6 __at(0x7A7E);


extern volatile __bit WPUC7 __at(0x7A7F);


extern volatile __bit WPUD0 __at(0x7AD0);


extern volatile __bit WPUD1 __at(0x7AD1);


extern volatile __bit WPUD2 __at(0x7AD2);


extern volatile __bit WPUD3 __at(0x7AD3);


extern volatile __bit WPUD4 __at(0x7AD4);


extern volatile __bit WPUD5 __at(0x7AD5);


extern volatile __bit WPUD6 __at(0x7AD6);


extern volatile __bit WPUD7 __at(0x7AD7);


extern volatile __bit WPUE0 __at(0x7B28);


extern volatile __bit WPUE1 __at(0x7B29);


extern volatile __bit WPUE2 __at(0x7B2A);


extern volatile __bit WPUE3 __at(0x7B2B);
...
extern volatile __bit ZCD1EN __at(0x48FF);


extern volatile __bit ZCD1INTN __at(0x48F8);


extern volatile __bit ZCD1INTP __at(0x48F9);


extern volatile __bit ZCD1OUT __at(0x48FD);


extern volatile __bit ZCD1POL __at(0x48FC);


extern volatile __bit ZCDEN __at(0x48FF);
...
# 76 "/home/pedro-linux/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8/pic/include/pic.h"
...
# 114 "/home/pedro-linux/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8/pic/include/eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);

# 127 "/home/pedro-linux/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8/pic/include/pic.h"
